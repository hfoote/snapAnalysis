...
def test_CDM_workflow(dm_snap):
	...
	dm_snap.density_projection(plot=False, slice_width=10.*u.kpc, plot_name='tests/density_plot_test.png')
	...
	dm_snap.potential_projection(plot=False, slice_width=10.*u.kpc, plot_name='tests/potential_plot_test.png')
